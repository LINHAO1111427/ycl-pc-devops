	...
	<div class="application">
		<div class="application-container">
			...
			<n-flex class="application-list" vertical :size="20">
				<div class="application-list-item" @click="$router.push('/talents-detail')">
					...
					<n-flex align="flex-end" justify="space-between">
						...
						<n-button type="primary" size="large" @click.stop="$router.push('/submit-proposals')">
							<span class="naiveui-text-16">立即申请项目</span>
						</n-button>
					</n-flex>
