...
<template>
    <div class="application">
        <div class="application-container">
            ...
            <n-flex class="application-list" vertical :size="20" :key="index">
                <div class="application-list-item" v-for="item,index in 3" @click.stop="$router.push('/client/submit-consult')">
                    ...
                    <n-flex align="flex-end" justify="space-between">
                        ...
                        <div class="application-item-title" style="margin-top: 30px">
                            <n-button type="primary" size="large" @click.stop="cancel_order()">
                                取消订单
                            </n-button>
                        </div>
                    </n-flex>
