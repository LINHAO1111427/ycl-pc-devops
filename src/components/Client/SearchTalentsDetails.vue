...
<template>
    <div class="talents-cart-container" v-for="(_item,index) in 10"  @click="emit('click')">
        <div class="talents-cart-container-left">
            ...
            <div class="cart-ellipsis-text" @click="emit('click')">
                <ellipsis>
                    职位描述： 你好！ 我们是Nutravision，一家致力于通过我们的补充剂促进眼睛健康的公司。我们需要一位熟练的翻译人员将我们的两本电子书从英语翻译成普通话。 责任： -
                    准确翻译两本电子书，同时保持原语气。 - 校对翻译以确保它们没有错误。 - 与我们的团队合作，确保质量。 要求： - 英语和普通话流利。 - 在翻译书面内容方面有丰富的经验。 -
                    非常注重细节和出色的校对技巧。 - 能够按时完成任务。 项目详情： - 电子书数量：1 - 总字数：主动青光眼电子书 6,500 字 - 截止日期：2周 - 赔偿：$400
                    加入我们，帮助向讲普通话的观众传播有价值的健康信息。请提供您的工作样本和翻译经验的简要概述。在这个项目完成后，很可能会有其他电子书和材料需要翻译。
                </ellipsis>
