...
<!--            <a style="color: #409eff;" href="https://example.com/image.jpg" download="my-image.jpg" target="_blank">附件地址</a>-->
<!--          </div>-->
<!--          <div style="width: 300px">-->
<!--            <a style="color: #409eff;" href="https://example.com/image.jpg" download="my-image.jpg" target="_blank">附件地址</a>-->
<!--          </div>-->
...
<!--        </n-flex>-->
    ...
    <div class="terms">
      ...
      <div class="content-textarea">
        <n-input placeholder="项目1" disabled="" type="textarea" style="height:400px;" :disabled="status != 0"/>
      </div>
    </div>
    <div class="tow-footer" v-if="status == 0">
      <n-flex justify="flex-end" :size="40">
        <n-button type="primary" text>取消</n-button>
        <n-button type="primary" @click="cancel_order()">确认结束项目</n-button>
      </n-flex>
    </div>
  </div>
</template>
