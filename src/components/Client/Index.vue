  ...
  <div class="easy">
    ...
    <div class="talents-container">
      ...
      <div class="pt-menu">
        ...
        <span>
                    <n-button type="primary" size="large" style="background: #3BC8B4;border:1px solid #3BC8B4;"
                              @click="$router.push('/client/addclient')">
                        <i class="icon-tianjia1 iconfont"></i>
                        <span style="font-size:14px;">发布招聘信息</span>
                    </n-button>
                </span>
      </div>
      <n-flex class="clientDiv" justify="space-between">
        <n-flex class="clientDivContent" align="center">
          <img src="../../assets/img/gz1.png"/>
...
<!--                </div>-->
      ...
      <!--            <n-tag size="small" class="easy-tag"-->
      <!--                   :color="{textColor:'#808080',borderColor:'#EDEDED',color:'#EDEDED'}" round>西班牙语-拉丁美洲-中立-->
      <!--            </n-tag>-->
      <!--            <n-tag size="small" class="easy-tag"-->
      <!--                   :color="{textColor:'#808080',borderColor:'#EDEDED',color:'#EDEDED'}" round>译本-->
      <!--            </n-tag>-->
      <!--            <n-tag size="small" class="easy-tag"-->
      <!--                   :color="{textColor:'#808080',borderColor:'#EDEDED',color:'#EDEDED'}" round>孩子-->
      <!--            </n-tag>-->
      <!--            <n-tag size="small" class="easy-tag"-->
      <!--                   :color="{textColor:'#808080',borderColor:'#EDEDED',color:'#EDEDED'}" round>录音-->
      <!--            </n-tag>-->
      <!--            <n-tag size="small" class="easy-tag"-->
      <!--                   :color="{textColor:'#808080',borderColor:'#EDEDED',color:'#EDEDED'}" round>+8-->
      <!--            </n-tag>-->
      <!--          </div>-->
