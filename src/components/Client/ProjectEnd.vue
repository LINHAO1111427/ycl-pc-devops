...
// 为里程碑付款
const ProjectPay = defineAsyncComponent(() => import('./ProjectPay.vue'))
const open_pay = ref(false)

// 里程碑审查
const ProjectApply = defineAsyncComponent(() => import('./ProjectApply.vue'))
const open_apply = ref(false)

// 评价
const ProjectRate = defineAsyncComponent(() => import('./ProjectRate.vue'))
...
<!--                    </div>-->
                ...
                <div class="terms">
                  <template v-if="job==1">
                    ...
                    <template v-if="type == 1">
                        ...
                        <div class="easy-btns">
                            <n-button type="primary" size="large" @click="open_apply = !open_apply">里程碑审查</n-button>
                            <n-button type="primary" size="large" @click="open_pay = !open_pay">为该里程碑付款</n-button>
                        </div>
                        <n-divider></n-divider>
                    </template>
    ...
    <!-- 评价 -->
    <ProjectRate v-model:show="open_rete" />
</template>
